    ...
    <header className="sticky top-0 z-50 border-b border-[#E4E9F2] bg-white">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-2 text-[#0E3FA8]" aria-label="RentGo beranda">
          ...
          <span className="text-2xl font-black tracking-tight">RentGo</span>
        </Link>
        ...
        {isAuthenticated ? (
          <div className="flex items-center gap-3 sm:gap-5">
            ...
            <Link href="/profile" className="flex items-center gap-3" aria-label="Buka profil">
              <span className="hidden text-right sm:block">
                <span className="block text-sm font-black text-[#132033]">Ahmadinezka Evan</span>
                <span className="block text-xs font-semibold text-[#667085]">Pelanggan</span>
              </span>
              <span className="grid h-11 w-11 place-items-center rounded-full bg-[#0E3FA8] text-sm font-black text-white">
                AE
              </span>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-5">
            ...
            <Link href="/login" className="hidden text-sm font-black text-[#0E3FA8] sm:inline">
              Login
            </Link>
            <Link href="/register" className="rounded-lg bg-[#0E3FA8] px-5 py-3 text-sm font-black text-white">
              Register
            </Link>
          </div>
        )}
