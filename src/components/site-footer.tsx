    ...
    <footer className="bg-[#2F3332] text-[#C9CECD]">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-[1.45fr_0.9fr_0.9fr_1fr]">
          ...
          <div>
            <h3 className="text-base font-black text-white">Perusahaan</h3>
          ...
          <div>
            <h3 className="text-base font-black text-white">Bantuan</h3>
            <ul className="mt-5 space-y-3 text-base">
              <li>
          ...
          <div>
            <h3 className="text-base font-black text-white">Kontak</h3>
            <ul className="mt-5 space-y-3 text-base">
