...
function Sidebar() {
  return <aside className="fixed inset-y-0 left-0 z-30 hidden w-[260px] flex-col border-r border-[#e5eaf1] bg-white text-[#17263b] lg:flex">
    <div className="flex h-[76px] items-center gap-3 border-b border-[#e5eaf1] px-7"><Image src="/referensi/Logo%20RentGo.svg" alt="RentGo" width={174} height={58} className="h-9 w-auto" /><span className="ml-1 rounded bg-[#eaf1ff] px-2 py-1 text-[10px] font-semibold text-[#245fd4]">Admin</span></div>
...
function Header() {
  return <header className="sticky top-0 z-20 flex h-[76px] items-center justify-between border-b border-[#e6eaf0] bg-white/95 px-5 backdrop-blur sm:px-8 lg:ml-[260px] lg:px-9">
    <Link href="/admin" className="flex items-center gap-2 text-[#0d1f3c] lg:hidden"><Image src="/referensi/Logo%20RentGo.svg" alt="RentGo" width={174} height={58} className="h-8 w-auto" /></Link>
